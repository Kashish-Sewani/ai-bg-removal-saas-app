      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          ...
          <div>
            ...
            <img className='rounded-md border border-gray-300' src={assets.image_w_bg} alt="image-with-background" />
          </div>
          ...
          <div className='flex flex-col'>
            ...
            <img src={assets.image_wo_bg} alt="image-without-background" />
